...
UsdOpenAssetIOResolver::UsdOpenAssetIOResolver() {
  ...
  logger_->debugApi("debugApi: " + manager_->identifier());
  logger_->debug("debug: " + manager_->identifier());
  logger_->info("info: " + manager_->identifier());
  logger_->progress("progress: " + manager_->identifier());
  logger_->warning("warning: " + manager_->identifier());
  logger_->error("error: " + manager_->identifier());
  logger_->critical("critical: " + manager_->identifier());
